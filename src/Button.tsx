...
const Button = styled.button<{color?: string, bgColor?: string, flexible?: boolean, isLoading?: boolean}>`
    &, &:active, &:hover {
        display: flex;
        position: relative;
        align-items: center;
        ...
        opacity: ${(props) => props.disabled || props.isLoading? "0.40" : "1"};
    }

    &:hover {
        box-shadow: ${(props) => props.disabled || props.isLoading? 'none' : 'rgb(0 0 0 / 20%) 0px 5px 5px -3px'};
    }
